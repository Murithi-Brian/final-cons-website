...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with FAFS - Fair Agri-Food Systems. We'd love to hear from you.",
}
...
export default function ContactPage() {
  return (
    <>
      <PageHeader
        title="Contact Us"
        description="We'd love to hear from you. Reach out to learn more about our work or explore partnership opportunities."
      />
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            {/* Contact Form */}
            <div className="bg-earth-50 rounded-lg p-8 border border-border">
